...
win.title("Shoulder Exercise Analysis")
...
can.create_text(450, 90, text="\"OpenCV Based Shoulder Exercise Analysis\"", font="Times 22 bold", fill="red")

can.create_text(110, 220, text="Designed By:", font="Times 20 underline", fill="red")

can.create_text(130, 300, text="Engr, Aadil Memon         \n\nEngr, Sajjad Ahmed", font="Times 15 bold italic", fill="red")

can.create_text(420, 220, text="Instructor:", font="Times 21 underline", fill="red")

can.create_text(390, 300, text="Mr. Zia ur Rehman", font="Times 15 bold italic", fill="red")
